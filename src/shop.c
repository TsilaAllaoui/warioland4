...
u32 ItemShopSubroutine(void)
{
    ...
    switch (gUnk_3000000) {
        ...
        case 1:
            func_80703DC();
            transitionComplete = func_80710D8(0, 1);
        ...
        case 8:
            func_80703DC();
            transitionComplete = func_80710D8(1, 1);
            if (transitionComplete != 0) {
