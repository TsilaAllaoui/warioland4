...
int UpdateRouletteGame(void)
{
    ...
    case 1:
        ...
        if (gMinigameCameraState.scale > 31)
            return 0;
        gMinigameCameraState.scale = 32;
        gMinigameCameraState.active = 0;
    ...
    case 5:
        {
            ...
            timerPtr = &gMinigameSequenceTimer;
            (*timerPtr)++;
            timer = *timerPtr;
