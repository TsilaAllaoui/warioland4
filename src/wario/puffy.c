...
void UpdatePuffyWarioPosition(void)
{
    ...
    hitbox = gUnk_3001918; data = sPuffyPoseData; wario = &gWarioData;
...
void LoadPuffyWarioGraphics(int index)
{
    ...
    gWarioPaletteSize = 0x20; func_800FD90(sUnk_82DE918, 0, 16);
}
...
void UpdatePuffyWarioHitbox(void)
{
    ...
    data = sPuffyPoseData; wario = &gWarioData; offset = data[wario->pose * 8]; hitboxes = (const u8 *)sUnk_82DEB18; offset <<= 3;
