...
void InitRouletteGame(void)
{
  ...
  ;
  {
    ...
    *scroll = zero;
    ...
    roundOffset = &gUnk_30047D6;
    *roundOffset = zero;
    rouletteState = &gUnk_30047D4;
    *rouletteState = zero;
...

    {
      ...
      *rouletteCounter = 48;
      ...
      gUnk_30047BA = 0;
      {
        ...
        resultState = &gUnk_30047BB;
        *resultState = 0;
      }
      {
        register u16 *resultTimer asm("r0");
        resultTimer = &gUnk_30047BC;
        *resultTimer = 0;
      }
      {
