...
extern const struct AnimationFrame sUnk_83CD374[];
extern const struct AnimationFrame sUnk_83CD39C[];
extern const struct AnimationFrame sUnk_83CD3EC[];
extern const struct AnimationFrame sUnk_83CE468[];
extern const struct AnimationFrame sUnk_83CE490[];
extern const struct AnimationFrame sUnk_83CE4A8[];
extern const struct AnimationFrame sUnk_83CE4D0[];
extern const struct AnimationFrame sUnk_83CE4F8[];
extern const struct AnimationFrame sUnk_83CF164[];
extern const struct AnimationFrame sUnk_83CF370[];
extern const struct AnimationFrame sUnk_83CF3F0[];
extern const struct AnimationFrame sUnk_83CF400[];
extern const struct AnimationFrame sUnk_83CF478[];
extern const struct AnimationFrame sUnk_83CF4B8[];
extern const struct AnimationFrame sUnk_83CF594[];
extern const struct AnimationFrame sUnk_83CF5BC[];
extern const struct AnimationFrame sUnk_83CF5D4[];
extern const struct AnimationFrame sUnk_83CF5EC[];
extern const struct AnimationFrame sUnk_83CF8BC[];
...
void func_804849C(void)
{
    ...
    if (current->health <= 1) {
        if (gUnk_3000A60 != 0)
            animation = sUnk_83CE4A8;
        else
            animation = sUnk_83CD374;
    } else {
        if (gUnk_3000A60 != 0)
            animation = sUnk_83CE468;
        else
            animation = sUnk_83CD334;
    }
...
void func_8048CBC(void)
{
    ...
    current = sprite;
    if (alternate != 0)
        animation = sUnk_83CE4D0;
    else
        animation = sUnk_83CD3EC;
    current->pOamData = animation;
    {
        register int zeroFrame asm("r0");
        register int zeroWork asm("r1");
...
void func_8048F84(void)
{
    ...
    sprite->pose = 22;
    if (gUnk_3000A60 != 0)
        sprite->pOamData = sUnk_83CE4A8;
    else
        sprite->pOamData = sUnk_83CD374;
    sprite->currentAnimationFrame = 0;
    sprite->animationTimer = 0;
    sprite->work2 = 60;
}
    ...
    if (timerValue != 0) {
        ...
        *timerPtr = timerValue;
        ...
        if (timerByte != 0) {
            ...
            initialSprite->pOamData = sUnk_83CF3F0;
