...
extern u8 gBossHurtState;
extern u8 gBossHurtTimer;
extern u8 gBossInitialHealth;
    ...
    if (value != 0) {
        ...
        *timer = value;
            ...
            return;
        {
            ...
            state = &gColorFadingState;
            value = 7;
            *state = value;
        }
    }
    value = gColorFadingState;
    if (value == 0) {
        value = 2;
        sprite->pose = value;
        value = 0x5A;
...
void SpriteCuckooCondor(void)
{
    ...
    if (gCurrentSprite.health >= ((gBossInitialHealth >> 1) + 1)
