...
void WaitForShopkeeperRoomReady(void){if(gBossDefeatTimer==0)gCurrentSprite.pose=2;}
...
void MoveShopkeeperToSmilePosition(void)
{
    ...
    value = *(u8 *)&gBossInteractionState;
    if (value != 0) {
        s = &gCurrentSprite;
        value = *(u32 *)((u32)s + 20);
        temp = 0xFFFFFF;
        ...
        *(volatile u8 *)temp = value;
        ...
        if (offset == 0) {
            ...
            *(volatile u8 *)((u32)s + 22) = value;
            ...
            value = 197;
            m4aSongNumStart(value);
            temp = (u32)&gBossInteractionState;
            value = 2;
            *(volatile u8 *)temp = value;
        }
    }
...
void WaitForShopkeeperSmileEffect(void)
{
    ...
    if (zero != 0) {
        ...
        *timer = value;
        ...
        value = *(volatile u8 *)&gBossInteractionState;
        if (value == 4) {
            value = 60;
            s->pose = value;
...
void MoveShopkeeperVizormanIntoPosition(void)
{
    ...
    r0 = *passagePtr;
    if (r0 == 5) {
        r0 = *(volatile u8 *)&gBossInteractionState;
        if (r0 == 0)
            goto end;
    }
    r5 = &gCurrentSprite;
...
void MoveShopkeeperBlastCannonIntoPosition(void)
{
    ...
    value = gCurrentPassage;
    if (value == 5 && *(u8 *)&gBossInteractionState == 0) {
        return;
    }
    s = &gCurrentSprite;
    value = (u32)s + 42;
