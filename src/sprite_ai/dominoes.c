...
extern int func_806DD44(int y, int x);
...
void InitDominoActivator(void)
{
    ...
    sprite->pOamData = sDominoActivatorAnimation;
...
void UpdateDominoChain(void)
{
    ...
    switch (func_806DD44(yTile, xTile)) {
    case 9: {
        ...
        *storePtr = value;
        ...
        sprite->work2 = yTile;
        sprite->work3 = xTile;
        collision = func_806DD44(yTile, xTile + 4);
        if (collision == 19)
...
void InitDominoLongPieceA(void)
{
    ...
    sprite->pOamData = sDominoLongPieceAAnimation;
    sprite->currentAnimationFrame = 0;
    sprite->animationTimer = 0;
    sprite->pose = 16;
}
...
void InitDominoLongPieceB(void)
{
    ...
    sprite->warioCollision = 6;
    sprite->drawPriority = 3;
    sprite->pOamData = sDominoLongPieceBAnimation;
    sprite->currentAnimationFrame = 0;
    sprite->animationTimer = 0;
    sprite->pose = 16;
}
...
void InitDominoGoalClosed(void)
{
    ...
    sprite->xPosition -= 32;
    sprite->drawPriority = 3;
    sprite->pOamData = sDominoGoalClosedAnimation;
    sprite->currentAnimationFrame = 0;
    sprite->animationTimer = 0;
    sprite->pose = 16;
    sprite->work0 = 30;
...
void InitDominoGoalOpenLeft(void)
{
    ...
    sprite->xPosition -= 32;
    sprite->drawPriority = 3;
    sprite->pOamData = sDominoGoalOpenLeftAnimation;
    sprite->currentAnimationFrame = 0;
    sprite->animationTimer = 0;
    sprite->pose = 24;
    sprite->work1 = 0;
...
void InitDominoGoalOpenRight(void)
{
    ...
    sprite->xPosition -= 32;
    sprite->drawPriority = 3;
    sprite->pOamData = sDominoGoalOpenRightAnimation;
    sprite->currentAnimationFrame = 0;
    sprite->animationTimer = 0;
    sprite->pose = 24;
    sprite->work1 = 0;
...
void UpdateDominoGoalClosed(void)
{
    ...
    if (*persistent == 17) {
        ...
        *(u8 *)temp = value;
        ...
        zero = (u32)value >> 24;
        if (zero == 0) {
            sprite->pOamData = sDominoGoalOpeningAnimation;
...
case10:
    oam = sDominoTile0Animation1;
    asm volatile("" : "+r"(oam) : "i"(0x10));
    goto store;
case20:
    oam = sDominoTile0Animation2;
    asm volatile("" : "+r"(oam) : "i"(0x20));
    goto store;
case30:
    oam = sDominoTile0Animation3;
    asm volatile("" : "+r"(oam) : "i"(0x30));
    goto store;
case40:
    oam = sDominoTile0Animation4;
    asm volatile("" : "+r"(oam) : "i"(0x40));
    goto store;
case50:
    oam = sDominoTile0Animation5;
    asm volatile("" : "+r"(oam) : "i"(0x50));
    goto store;
case60:
    oam = sDominoTile0Animation6;
    asm volatile("" : "+r"(oam) : "i"(0x60));
    goto store;
case70:
    asm("" : : "r"(value));
    oam = sDominoTile0Animation7;
    asm volatile("" : "+r"(oam) : "i"(0x70));
    goto store;
useDefault:
    oam = sDominoTile0Animation0;
store:
    sprite->pOamData = oam;
}
...
case10:
    oam = sDominoTile1Animation1;
    asm volatile("" : "+r"(oam) : "i"(0x10));
    goto store;
case20:
    oam = sDominoTile1Animation2;
    asm volatile("" : "+r"(oam) : "i"(0x20));
    goto store;
case30:
    oam = sDominoTile1Animation3;
    asm volatile("" : "+r"(oam) : "i"(0x30));
    goto store;
case40:
    oam = sDominoTile1Animation4;
    asm volatile("" : "+r"(oam) : "i"(0x40));
    goto store;
case50:
    oam = sDominoTile1Animation5;
    asm volatile("" : "+r"(oam) : "i"(0x50));
    goto store;
case60:
    oam = sDominoTile1Animation6;
    asm volatile("" : "+r"(oam) : "i"(0x60));
    goto store;
case70:
    asm("" : : "r"(value));
    oam = sDominoTile1Animation7;
    asm volatile("" : "+r"(oam) : "i"(0x70));
    goto store;
useDefault:
    oam = sDominoTile1Animation0;
store:
    sprite->pOamData = oam;
}
...
case10:
    oam = sDominoTile2Animation1;
    asm volatile("" : "+r"(oam) : "i"(0x10));
    goto store;
case20:
    oam = sDominoTile2Animation2;
    asm volatile("" : "+r"(oam) : "i"(0x20));
    goto store;
case30:
    oam = sDominoTile2Animation3;
    asm volatile("" : "+r"(oam) : "i"(0x30));
    goto store;
case40:
    oam = sDominoTile2Animation4;
    asm volatile("" : "+r"(oam) : "i"(0x40));
    goto store;
case50:
    oam = sDominoTile2Animation5;
    asm volatile("" : "+r"(oam) : "i"(0x50));
    goto store;
case60:
    oam = sDominoTile2Animation6;
    asm volatile("" : "+r"(oam) : "i"(0x60));
    goto store;
case70:
    oam = sDominoTile2Animation7;
    asm volatile("" : "+r"(oam) : "i"(0x70));
    goto store;
case80:
    oam = sDominoTile2Animation8;
    asm volatile("" : "+r"(oam) : "i"(0x80));
    goto store;
case90:
    asm("" : : "r"(value));
    oam = sDominoTile2Animation9;
    asm volatile("" : "+r"(oam) : "i"(0x90));
    goto store;
useDefault:
    oam = sDominoTile2Animation0;
store:
    sprite->pOamData = oam;
}
...
case10:
    oam = sDominoTile3Animation1;
    asm volatile("" : "+r"(oam) : "i"(0x10));
    goto store;
case20:
    oam = sDominoTile3Animation2;
    asm volatile("" : "+r"(oam) : "i"(0x20));
    goto store;
case30:
    oam = sDominoTile3Animation3;
    asm volatile("" : "+r"(oam) : "i"(0x30));
    goto store;
case40:
    oam = sDominoTile3Animation4;
    asm volatile("" : "+r"(oam) : "i"(0x40));
    goto store;
case50:
    oam = sDominoTile3Animation5;
    asm volatile("" : "+r"(oam) : "i"(0x50));
    goto store;
case60:
    oam = sDominoTile3Animation6;
    asm volatile("" : "+r"(oam) : "i"(0x60));
    goto store;
case70:
    oam = sDominoTile3Animation7;
    asm volatile("" : "+r"(oam) : "i"(0x70));
    goto store;
case80:
    oam = sDominoTile3Animation8;
    asm volatile("" : "+r"(oam) : "i"(0x80));
    goto store;
case90:
    asm("" : : "r"(value));
    oam = sDominoTile3Animation9;
    asm volatile("" : "+r"(oam) : "i"(0x90));
    goto store;
useDefault:
    oam = sDominoTile3Animation0;
store:
    sprite->pOamData = oam;
}
...
case10:
    oam = sDominoTile4Animation1;
    asm volatile("" : "+r"(oam) : "i"(0x10));
    goto store;
case20:
    oam = sDominoTile4Animation2;
    asm volatile("" : "+r"(oam) : "i"(0x20));
    goto store;
case30:
    oam = sDominoTile4Animation3;
    asm volatile("" : "+r"(oam) : "i"(0x30));
    goto store;
case40:
    oam = sDominoTile4Animation4;
    asm volatile("" : "+r"(oam) : "i"(0x40));
    goto store;
case50:
    oam = sDominoTile4Animation5;
    asm volatile("" : "+r"(oam) : "i"(0x50));
    goto store;
case60:
    oam = sDominoTile4Animation6;
    asm volatile("" : "+r"(oam) : "i"(0x60));
    goto store;
case70:
    oam = sDominoTile4Animation7;
    asm volatile("" : "+r"(oam) : "i"(0x70));
    goto store;
case80:
    asm("" : : "r"(value));
    oam = sDominoTile4Animation8;
    asm volatile("" : "+r"(oam) : "i"(0x80));
    goto store;
useDefault:
    oam = sDominoTile4Animation0;
store:
    sprite->pOamData = oam;
}
...
case10:
    oam = sDominoTile5Animation1;
    asm volatile("" : "+r"(oam) : "i"(0x10));
    goto store;
case20:
    oam = sDominoTile5Animation2;
    asm volatile("" : "+r"(oam) : "i"(0x20));
    goto store;
case30:
    oam = sDominoTile5Animation3;
    asm volatile("" : "+r"(oam) : "i"(0x30));
    goto store;
case40:
    oam = sDominoTile5Animation4;
    asm volatile("" : "+r"(oam) : "i"(0x40));
    goto store;
case50:
    oam = sDominoTile5Animation5;
    asm volatile("" : "+r"(oam) : "i"(0x50));
    goto store;
case60:
    oam = sDominoTile5Animation6;
    asm volatile("" : "+r"(oam) : "i"(0x60));
    goto store;
case70:
    oam = sDominoTile5Animation7;
    asm volatile("" : "+r"(oam) : "i"(0x70));
    goto store;
case80:
    asm("" : : "r"(value));
    oam = sDominoTile5Animation8;
    asm volatile("" : "+r"(oam) : "i"(0x80));
    goto store;
useDefault:
    oam = sDominoTile5Animation0;
store:
    sprite->pOamData = oam;
}
...
case20:
    sprite->pOamData = sDominoTile6Animation1;
    return;
case30:
    sprite->pOamData = sDominoTile6Animation1;
    return;
case40:
    sprite->pOamData = sDominoTile6Animation2;
    return;
case50:
    sprite->pOamData = sDominoTile6Animation2;
    return;
case60:
    sprite->pOamData = sDominoTile6Animation3;
    return;
case70:
    sprite->pOamData = sDominoTile6Animation3;
    return;
case80:
    sprite->pOamData = sDominoTile6Animation4;
    return;
case90:
    sprite->pOamData = sDominoTile6Animation4;
    return;
caseA0:
    sprite->pOamData = sDominoTile6Animation5;
    return;
caseB0:
    sprite->pOamData = sDominoTile6Animation6;
    return;
caseC0:
    sprite->pOamData = sDominoTile6Animation7;
    return;
caseD0:
    sprite->pOamData = sDominoTile6Animation8;
    return;
caseE0:
    sprite->pOamData = sDominoTile6Animation9;
    return;
useDefault:
    sprite->pOamData = sDominoTile6Animation0;
}
...
case20:
    sprite->pOamData = sDominoTile7Animation1;
    return;
case30:
    sprite->pOamData = sDominoTile7Animation1;
    return;
case40:
    sprite->pOamData = sDominoTile7Animation2;
    return;
case50:
    sprite->pOamData = sDominoTile7Animation2;
    return;
case60:
    sprite->pOamData = sDominoTile7Animation3;
    return;
case70:
    sprite->pOamData = sDominoTile7Animation3;
    return;
case80:
    sprite->pOamData = sDominoTile7Animation4;
    return;
case90:
    sprite->pOamData = sDominoTile7Animation4;
    return;
caseA0:
    sprite->pOamData = sDominoTile7Animation5;
    return;
caseB0:
    sprite->pOamData = sDominoTile7Animation6;
    return;
caseC0:
    sprite->pOamData = sDominoTile7Animation7;
    return;
caseD0:
    sprite->pOamData = sDominoTile7Animation8;
    return;
caseE0:
    sprite->pOamData = sDominoTile7Animation9;
    return;
useDefault:
    sprite->pOamData = sDominoTile7Animation0;
}
...
case20:
    sprite->pOamData = sDominoTile8Animation1;
    return;
case30:
    sprite->pOamData = sDominoTile8Animation1;
    return;
case40:
    sprite->pOamData = sDominoTile8Animation2;
    return;
case50:
    sprite->pOamData = sDominoTile8Animation2;
    return;
case60:
    sprite->pOamData = sDominoTile8Animation3;
    return;
case70:
    sprite->pOamData = sDominoTile8Animation3;
    return;
case80:
    sprite->pOamData = sDominoTile8Animation4;
    return;
case90:
    sprite->pOamData = sDominoTile8Animation4;
    return;
caseA0:
    sprite->pOamData = sDominoTile8Animation5;
    return;
caseB0:
    sprite->pOamData = sDominoTile8Animation6;
    return;
caseC0:
    sprite->pOamData = sDominoTile8Animation7;
    return;
caseD0:
    sprite->pOamData = sDominoTile8Animation8;
    return;
caseE0:
    sprite->pOamData = sDominoTile8Animation9;
    return;
useDefault:
    sprite->pOamData = sDominoTile8Animation0;
}
...
case20:
    sprite->pOamData = sDominoTile9Animation1;
    return;
case30:
    sprite->pOamData = sDominoTile9Animation1;
    return;
case40:
    sprite->pOamData = sDominoTile9Animation2;
    return;
case50:
    sprite->pOamData = sDominoTile9Animation2;
    return;
case60:
    sprite->pOamData = sDominoTile9Animation3;
    return;
case70:
    sprite->pOamData = sDominoTile9Animation3;
    return;
case80:
    sprite->pOamData = sDominoTile9Animation4;
    return;
case90:
    sprite->pOamData = sDominoTile9Animation4;
    return;
caseA0:
    sprite->pOamData = sDominoTile9Animation5;
    return;
caseB0:
    sprite->pOamData = sDominoTile9Animation6;
    return;
caseC0:
    sprite->pOamData = sDominoTile9Animation7;
    return;
caseD0:
    sprite->pOamData = sDominoTile9Animation8;
    return;
caseE0:
    sprite->pOamData = sDominoTile9Animation9;
    return;
useDefault:
    sprite->pOamData = sDominoTile9Animation0;
}
...
void SpriteDominoTile4(void)
{
    ...
    switch (sprite->pose) {
    case 1:
        gCurrentSprite.pOamData = sDominoTile4Animation1;
        InitDominoTile4();
        return;
    case 2:
        gCurrentSprite.pOamData = sDominoTile4Animation2;
        InitDominoTile4();
        return;
    case 3:
        gCurrentSprite.pOamData = sDominoTile4Animation3;
        InitDominoTile4();
        return;
    case 4:
        gCurrentSprite.pOamData = sDominoTile4Animation4;
        InitDominoTile4();
        return;
    case 5:
        gCurrentSprite.pOamData = sDominoTile4Animation5;
        InitDominoTile4();
        return;
    case 6:
        gCurrentSprite.pOamData = sDominoTile4Animation6;
        InitDominoTile4();
        return;
    case 7:
        gCurrentSprite.pOamData = sDominoTile4Animation7;
        InitDominoTile4();
        return;
    case 8:
        gCurrentSprite.pOamData = sDominoTile4Animation8;
        InitDominoTile4();
        return;
    case 16:
        ...
        return;
    default:
        gCurrentSprite.pOamData = sDominoTile4Animation0;
        InitDominoTile4();
        return;
    }
}
...
void SpriteDominoTile5(void)
{
    ...
    switch (sprite->pose) {
    case 1:
        gCurrentSprite.pOamData = sDominoTile5Animation1;
        InitDominoTile5();
        return;
    case 2:
        gCurrentSprite.pOamData = sDominoTile5Animation2;
        InitDominoTile5();
        return;
    case 3:
        gCurrentSprite.pOamData = sDominoTile5Animation3;
        InitDominoTile5();
        return;
    case 4:
        gCurrentSprite.pOamData = sDominoTile5Animation4;
        InitDominoTile5();
        return;
    case 5:
        gCurrentSprite.pOamData = sDominoTile5Animation5;
        InitDominoTile5();
        return;
    case 6:
        gCurrentSprite.pOamData = sDominoTile5Animation6;
        InitDominoTile5();
        return;
    case 7:
        gCurrentSprite.pOamData = sDominoTile5Animation7;
        InitDominoTile5();
        return;
    case 8:
        gCurrentSprite.pOamData = sDominoTile5Animation8;
        InitDominoTile5();
        return;
    case 16:
        ...
        return;
    default:
        gCurrentSprite.pOamData = sDominoTile5Animation0;
        InitDominoTile5();
        return;
    }
}
...
void SpriteDominoTile6(void)
{
    ...
    case 1:
        target = &gCurrentSprite;
        oam = sDominoTile6Animation0;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(1));
        goto commonUpdate;
    case 2:
        target = &gCurrentSprite;
        oam = sDominoTile6Animation1;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(2));
        goto commonUpdate;
    case 3:
        target = &gCurrentSprite;
    ...
    case 10:
        target = &gCurrentSprite;
        oam = sDominoTile6Animation5;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(10));
        goto commonUpdate;
    case 11:
        target = &gCurrentSprite;
        oam = sDominoTile6Animation6;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(11));
        goto commonUpdate;
    case 12:
        target = &gCurrentSprite;
        oam = sDominoTile6Animation7;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(12));
        goto commonUpdate;
    case 13:
        target = &gCurrentSprite;
        oam = sDominoTile6Animation8;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(13));
        goto commonUpdate;
    case 14:
        target = &gCurrentSprite;
        oam = sDominoTile6Animation9;
...
void SpriteDominoTile7(void)
{
    ...
    case 1:
        target = &gCurrentSprite;
        oam = sDominoTile7Animation0;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(1));
        goto commonUpdate;
    case 2:
        target = &gCurrentSprite;
        oam = sDominoTile7Animation1;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(2));
        goto commonUpdate;
    case 3:
        target = &gCurrentSprite;
    ...
    case 10:
        target = &gCurrentSprite;
        oam = sDominoTile7Animation5;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(10));
        goto commonUpdate;
    case 11:
        target = &gCurrentSprite;
        oam = sDominoTile7Animation6;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(11));
        goto commonUpdate;
    case 12:
        target = &gCurrentSprite;
        oam = sDominoTile7Animation7;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(12));
        goto commonUpdate;
    case 13:
        target = &gCurrentSprite;
        oam = sDominoTile7Animation8;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(13));
        goto commonUpdate;
    case 14:
        target = &gCurrentSprite;
        oam = sDominoTile7Animation9;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(14));
        goto commonUpdate;
    case 16:
        goto selectAnimation;
...
void SpriteDominoTile8(void)
{
    ...
    case 1:
        target = &gCurrentSprite;
        oam = sDominoTile8Animation0;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(1));
        goto commonUpdate;
    case 2:
        target = &gCurrentSprite;
        oam = sDominoTile8Animation1;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(2));
        goto commonUpdate;
    case 3:
        target = &gCurrentSprite;
    ...
    case 10:
        target = &gCurrentSprite;
        oam = sDominoTile8Animation5;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(10));
        goto commonUpdate;
    case 11:
        target = &gCurrentSprite;
        oam = sDominoTile8Animation6;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(11));
        goto commonUpdate;
    case 12:
        target = &gCurrentSprite;
        oam = sDominoTile8Animation7;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(12));
        goto commonUpdate;
    case 13:
        target = &gCurrentSprite;
        oam = sDominoTile8Animation8;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(13));
        goto commonUpdate;
    case 14:
        target = &gCurrentSprite;
        oam = sDominoTile8Animation9;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(14));
        goto commonUpdate;
    case 16:
        goto selectAnimation;
...
void SpriteDominoTile9(void)
{
    ...
    case 1:
        target = &gCurrentSprite;
        oam = sDominoTile9Animation0;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(1));
        goto commonUpdate;
    case 2:
        target = &gCurrentSprite;
        oam = sDominoTile9Animation1;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(2));
        goto commonUpdate;
    case 3:
        target = &gCurrentSprite;
    ...
    case 10:
        target = &gCurrentSprite;
        oam = sDominoTile9Animation5;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(10));
        goto commonUpdate;
    case 11:
        target = &gCurrentSprite;
        oam = sDominoTile9Animation6;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(11));
        goto commonUpdate;
    case 12:
        target = &gCurrentSprite;
        oam = sDominoTile9Animation7;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(12));
        goto commonUpdate;
    case 13:
        target = &gCurrentSprite;
        oam = sDominoTile9Animation8;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(13));
        goto commonUpdate;
    case 14:
        target = &gCurrentSprite;
        oam = sDominoTile9Animation9;
        asm volatile("" : "+r"(target), "+r"(oam) : "i"(14));
        goto commonUpdate;
    case 16:
        goto selectAnimation;
